#!/bin/bash
# Day 16 Docker Image Layer Size footprint audit and optimization benchmark
...
# Clean existing build images
echo -e "${BLUE}Cleaning legacy test images...${NC}"
...
echo -e "\n${GREEN}===================================================${NC}"
echo -e "${GREEN}📊 FOOTPRINT PERFORMANCE COMPARISON REPORT:${NC}"
echo -e "${GREEN}===================================================${NC}"
